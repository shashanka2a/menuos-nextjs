...
const bases = [
  { id: "rice", name: "Basmati Rice", price: 0 },
  { id: "salad", name: "Mixed Greens", price: 0 },
  { id: "fries", name: "Crispy Fries", price: 1.5 },
];

const proteins = [
  { id: "chicken", name: "Grilled Chicken", price: 0 },
  { id: "falafel", name: "Crispy Falafel", price: 0 },
  { id: "gyro", name: "Lamb Gyro", price: 2 },
  { id: "tofu", name: "Marinated Tofu", price: 0 },
];

const addons = [
  { id: "white-sauce", name: "White Sauce", price: 0 },
  { id: "hot-sauce", name: "Hot Sauce", price: 0 },
  { id: "cheese", name: "Feta Cheese", price: 1.5 },
...
export function ItemDetailsModal({
  ...
  const [selectedBase, setSelectedBase] = useState("rice");
